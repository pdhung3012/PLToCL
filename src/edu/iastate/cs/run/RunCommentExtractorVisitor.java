...
public class RunCommentExtractorVisitor {
	...
	public static void main(String[] args) {
		...
		String[] arrSources=findAllJavaFiles(PathConstanct.PATH_SOURCECODECOMMENT);
		System.out.println(arrSources.length);
		
		
		
	}
	
	public static void findFiles(File root,String extension,ArrayList<String> lstFilePaths)
	{
